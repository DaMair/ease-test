package at.adma.ease.repository;

import at.adma.ease.EaseApp;
import at.adma.ease.config.Constants;
import at.adma.ease.config.audit.AuditEventConverter;
import at.adma.ease.domain.PersistentAuditEvent;
...
import static at.adma.ease.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
